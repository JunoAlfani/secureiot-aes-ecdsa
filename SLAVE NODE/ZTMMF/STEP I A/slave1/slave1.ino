// ===============================
// ✅ ESP8266-1 - Tahap 1: Generate PairKey & Signature
// ===============================
...
// ip esp A : 192.168.20.2
// ip esp B : 192.168.30.247
const char* ssid = "VLAN20_Access";
const char* password = "vlan2012345";
const char* esp32_host = "192.168.20.5";
const uint16_t esp32_port = 8888;

#define EEPROM_SIZE 512
const char* device_id = "1"; // IDENTITAS SLAVE NODE DARI 1-3
